...
export const SECTIONS: { id: PaperSection; icon: React.ReactElement }[] = [
  ...
  { id: PaperSection.SUPPLEMENTAL_MATERIAL, icon: React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", className: "h-5 w-5", viewBox: "0 0 20 20", fill: "currentColor" }, React.createElement('path', { fillRule: "evenodd", d: "M8 4a3 3 0 00-3 3v4a5 5 0 0010 0V7a3 3 0 10-6 0v4a1 1 0 102 0V7a1 1 0 112 0v4a3 3 0 11-6 0V7a5 5 0 0110 0v4a5 5 0 01-10 0V7a3 3 0 00-3-3z", clipRule: "evenodd" })) },
];
...
export const EXAMPLE_TEXTS: Record<PaperSection, string> = {
  ...
  [PaperSection.SUPPLEMENTAL_MATERIAL]: `This document contains supplemental material for the paper "Emergent Spacetime from Quantum Entanglement."\n\nS1. Detailed Derivation of the Ryu-Takayanagi Formula\n\nWe provide a step-by-step derivation of the holographic entanglement entropy formula, S_A = Area(γ_A) / 4G_N, starting from the Euclidean path integral formulation of the AdS/CFT correspondence. This includes the full calculation of the gravitational action for a static, spherically symmetric black brane solution in AdS_5.\n\nS2. Numerical Simulation Code\n\nThe complete Python source code used for the tensor network contraction algorithms described in the Methods section is provided as a supplementary \`.zip\` file. The code is implemented using the TenPy library and requires a working installation of NumPy and SciPy. A \`requirements.txt\` file is included for easy setup.\n\nS3. Extended Data and Figures\n\nWe include additional data plots from our numerical simulations. Figure S1 shows the convergence of the entanglement entropy calculation as a function of bond dimension for various subregion sizes. Figure S2 provides a visualization of the minimal surface γ_A in the AdS bulk for a non-spherical entangling surface, demonstrating the robustness of our method.`
};